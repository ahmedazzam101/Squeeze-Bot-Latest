...
class Settings:
    ...
    claude_min_composite_score: float = _float("CLAUDE_MIN_COMPOSITE_SCORE", 62.0)
    claude_min_acceleration_score: float = _float("CLAUDE_MIN_ACCELERATION_SCORE", 55.0)
    claude_min_rvol: float = _float("CLAUDE_MIN_RVOL", 1.8)
    claude_cache_minutes: int = _int("CLAUDE_CACHE_MINUTES", 10)
    ...
    claude_max_calls_per_day: int = _int("CLAUDE_MAX_CALLS_PER_DAY", 20)
